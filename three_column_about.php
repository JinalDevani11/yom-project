						...
						<div class="row">
							...
							<div class="portfolio-page-nav text-center">
					            ...
					            <li class="page-item <?php echo ($page == 1) ? 'disabled' : ''; ?>">
					                <a class="page-link" href="three_column_about.php?page=<?php echo ($page - 1); ?>">Previous</a>
					            </li>
					            <?php 
					            for($i = 1; $i <= $total_page; $i++) {
					                echo "<li class='page-item " . ($page == $i ? 'active' : '') . "'><a class='page-link' href='three_column_about.php?page=$i'>$i</a></li> ";
					            }
					            ?>
					            <li class="page-item <?php echo ($page == $total_page) ? 'disabled' : ''; ?>">
					                <a class="page-link" href="three_column_about.php?page=<?php echo ($page + 1); ?>">Next</a>
					            </li>
				        		</ul>
    					</div>
					</div>
