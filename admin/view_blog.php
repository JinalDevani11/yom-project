...
if(isset($_GET['id'])) {
    ...
    if ($res) {
        ...
        if(file_exists('image/read/'.$data['image']) && $data['image'] !="") {
            unlink("image/read/".$data['image']);
        }
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="image/read/<?php echo $data['image'] ?>" alt="Image">
                                        <td><?php echo $data['title']; ?></td>
                                        <td><?php echo $data['d_date']; ?></td>
                                        <td><?php echo $data['des']; ?></td>
                                        <td><a href="view_blog.php?id=<?php echo $data['id'] ?>">Delete</a>||<a href="add_blog.php?id=<?php echo $data['id'] ?>">Edit</a></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                    ...
                    <a class="page-link" <?php if ($page == 1) { echo 'style="pointer-events: none; opacity: 0.5;"'; } ?> href='view_read.php?page=<?php echo ($page-1); ?>&title=<?php echo $search; ?>' class='button'>Previous</a>
